 ...
 *  8、当前温度
 */
public class ZvdView extends View {
    ...
    public ZvdView (Context context) {
        this(context, null);
    }

    public ZvdView (Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ZvdView (Context context, AttributeSet attrs, int defStyleAttr) {
